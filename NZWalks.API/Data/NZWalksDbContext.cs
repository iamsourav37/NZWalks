    ...
    public class NZWalksDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var roles = new List<IdentityRole>()
            {
                new IdentityRole()
                {
                    Id = "E04EADF4-DD9F-432C-9469-DD415C27CF2F",
                    Name ="Reader",
                    NormalizedName = "READER",
                    ConcurrencyStamp = "E04EADF4-DD9F-432C-9469-DD415C27CF2F"
                },
                new IdentityRole()
                {
                    Id = "F3107444-303E-4159-A73F-30CB73329D87",
                    Name ="Writer",
                    NormalizedName = "WRITER",
                    ConcurrencyStamp = "F3107444-303E-4159-A73F-30CB73329D87"
                }
            };
